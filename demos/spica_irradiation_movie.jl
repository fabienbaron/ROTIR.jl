...
ax[0].set_title(@sprintf("Spica mutual irradiation, bolometric albedo = %.2f", albedo))
ax[1].plot(phases, seps, "k-", lw=2)
ax[1].set_ylabel("separation D (mas)")
ax[1].set_xlabel("orbital phase (0 = periastron)")
ax[1].grid(alpha=0.3)
tight_layout()
mkpath(outdir)
