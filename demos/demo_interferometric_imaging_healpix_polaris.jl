...
# LOAD DATA
oifitsfile = "./data/vscale_mjd_oiprep_2021Apr02_03_04_MIRCX_HD_8890_AVG15m_all.fits"
#oifitsfile = "./data/vscale_mjd_oiprep_2019Sep02_MIRCX_HD_8890_AVG15m_E1W2W1E2_all.fits"
nepochs = 1
tepochs = [0.0]
...
starparams = [3.16/2,  # milliarcseconds (radius at pole)
     7200.,              # Kelvin (at pole)
...
regularizers = [["tv",5e-2, tvinfo,1:length(temperature_start)],["tv2",5e-6, tvinfo,1:length(temperature_start)] ];
...
plot2d_temperature(temperature, star_epoch_geom[1], plotmesh=false, xlim=[3, -3], ylim=[-3, 3], colormap="gist_heat"); # Note: Temp = intensity since no LDD
